...
document.writeln("}");
document.writeln(".window .alert_title {");
document.writeln("	");
...
document.writeln("}");
document.writeln("");
document.writeln(".window .alert_title .close {");
...
document.writeln("	<div id=\"alert_title\" class=\"alert_title\">消息提醒<span class=\"close\" id=\"alertclose\"><\/span><\/div>");
...
$("#txt").html(alert_title);
//$("#windowcenter").hide("slow"); 
$("#windowcenter").css("top",$(document).scrollTop()+$(window).height()-320);

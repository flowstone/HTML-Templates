<form class="form-horizontal">
  ...
  <div id="shipping-existing">
    <select name="address_id" class="form-control">
      ...
      <option value="<?php echo $address['address_id']; ?>" selected="selected"><?php echo $address['firstname']; ?>, <?php echo $address['country']; ?>, <?php echo $address['zone']; ?>, <?php echo $address['city']; ?>, <?php echo $address['address_1']; ?></option>
      <?php } else { ?>
      <option value="<?php echo $address['address_id']; ?>"><?php echo $address['firstname']; ?>, <?php echo $address['country']; ?>, <?php echo $address['zone']; ?>, <?php echo $address['city']; ?>, <?php echo $address['address_1']; ?></option>
      <?php } ?>
      <?php } ?>
    </select>
  </div>
...
$('#collapse-shipping-address select[name=\'country_id\']').on('change', function() {
	$.ajax({
		...
		success: function(json) {
			...
			$('#collapse-shipping-address select[name=\'city\']').html('<option><?php echo $text_select; ?></option>');
...
//--></script>
<script type="text/javascript"><!--
$('#collapse-shipping-address select[name=\'zone_id\']').bind('change', function() {
